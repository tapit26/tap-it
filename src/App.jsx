...
.dash-top { border-bottom:1px solid var(--line); background:rgba(255,255,255,.8); backdrop-filter:blur(10px); position:sticky; top:0; z-index:30; padding:12px 24px; }
...
@media (max-width: 860px) {
  ...
  .side { display:none; }
  .mobile-bar { display:flex; position:sticky; bottom:0; z-index:40; background:rgba(255,255,255,.94); backdrop-filter:blur(12px); border-top:1px solid var(--line); padding:8px 6px calc(8px + env(safe-area-inset-bottom)); }
...
function Task({ done, label, onClick }) {
  return (
    <button
      onClick={onClick}
      className="row"
      style={{ width: "100%", textAlign: "left", background: done ? "#F7FCFA" : "var(--w)", border: `1px solid ${done ? "#D6EFE4" : "var(--line)"}`, borderRadius: 13, padding: "11px 13px", cursor: "pointer" }}
    >
    ...
    view = (
      <div style={{ minHeight: "100vh", display: "grid", placeItems: "center" }}>
        <div className="stack center">
          <div style={{ display: "flex", justifyContent: "center" }}>{I.logo(34)}</div>
