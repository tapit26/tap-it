...
const SOCIALS = {
  ...
  instapay: { label: "InstaPay", base: "", path: "M2 5h2.6v14H2V5Zm5 0 6 7-6 7h3.1l6-7-6-7H7Zm4.6 0 6 7-6 7h3.1l6-7-6-7h-3.1ZM16.9 5H21c2 0 3.3 1.6 3.3 3.6S23 12.2 21 12.2h-1.5V19h-2.6V5Zm2.6 2.2v2.8H21c.7 0 1.1-.5 1.1-1.4s-.4-1.4-1.1-1.4h-1.5Z" },
};
