...
const SOCIALS = {
  ...
  snapchat: { label: "Snapchat", base: "snapchat.com/add/", path: "M12 2.6c2.7 0 4.9 2.2 5 5v2.1c0 .3.3.5.6.6.5.1 1.1-.2 1.4-.3.2 0 .4 0 .5.2.1.3 0 .6-.2.8-.2.2-1.2.9-1.9 1.2-.2.1-.3.3-.2.6.4 1.3 1.7 2.9 4.1 3.5.2 0 .3.2.3.4 0 .4-.9.8-2.4 1-.1.2-.1.5-.2.7 0 .2-.2.3-.5.3-1 0-1.6.5-3 1.1-1 .5-2 1-3.5 1s-2.5-.5-3.5-1c-1.4-.6-2-1.1-3-1.1-.3 0-.5-.1-.5-.3-.1-.2-.1-.5-.2-.7-1.5-.2-2.4-.6-2.4-1 0-.2.1-.3.3-.4 2.4-.6 3.7-2.2 4.1-3.5.1-.3 0-.5-.2-.6-.5-.3-1.5-.9-1.8-1.2-.3-.3-.4-.6-.3-.8.1-.2.3-.2.6-.2.3.1.8.4 1.3.3.3-.1.6-.3.6-.6V7.6c.1-2.8 2.3-5 5-5Z" },
  gmaps: { label: "Google Maps", base: "https://maps.google.com/?q=", path: "M12 2C8.1 2 5 5.1 5 9c0 5.2 7 13 7 13s7-7.8 7-13c0-3.9-3.1-7-7-7Zm0 9.5A2.5 2.5 0 1 1 12 6.5a2.5 2.5 0 0 1 0 5Z" },
  instapay: { label: "InstaPay", base: "", path: "M0.8 5h2.2v14H0.8V5Zm3.8 0 4.5 7-4.5 7h2l4.5-7-4.5-7H4.6Zm3 0 4.5 7-4.5 7h2l4.5-7-4.5-7H7.6ZM15.3 5H19.4c2 0 3.3 1.6 3.3 3.6S21.4 12.2 19.4 12.2h-1.5V19h-2.6V5Zm2.6 2.2v2.8H19.4c.7 0 1.1-.5 1.1-1.4s-.4-1.4-1.1-1.4h-1.5Z" },
};
            ...
            <div className="stack" style={{ "--gap": "10px", marginTop: 16 }}>
              ...
              <div className="row" style={{ gap: 8, flexWrap: "wrap" }}>
                <select
                  ...
                  aria-label="Platform"
                >
                  {Object.keys(SOCIALS).filter((k) => k !== "gmaps" && k !== "instapay").map((k) => <option key={k} value={k}>{SOCIALS[k].label}</option>)}
                </select>
                <input
                  className="inp"
